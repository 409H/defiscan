    ...
    return (
        <div>
          ...
          <AssetView 
            ...
            icon={LogoRep}
            rows={[
              ["POOLED", <Currency value={this.state.REP.user.balance} symbol="REP" usd_value={this.state.REP.value_in_usd*parseFloat(this.state.REP.user.balance)} />],
              //["ETH VALUE", <Currency value={this.state.BAT.user.balance_in_eth} symbol="ETH" />],
              ["POOL SIZE", <Currency value={this.state.REP.exchange.currentPool} symbol="REP" usd_value={this.state.REP.value_in_usd*parseFloat(this.state.REP.exchange.currentPool)} />],
              ["ADDRESS SHARE", this.state.REP.user.share_perc + "%"]
            ]}
